"""Autonomous mapping launch for the real robot.

This bringup entrypoint intentionally uses the vacuum_driver real-hardware
pipeline so the Arduino serial link, odometry, IMU, scan filtering, SLAM, and
autonomy all follow the same path as ``vacuum_driver/autonomous_mapping``.
"""
